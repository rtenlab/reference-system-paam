...
#ifndef REFERENCE_SYSTEM__paam_WRAPPERS_HPP_
#define REFERENCE_SYSTEM__paam_WRAPPERS_HPP_
...
class paam_client_wrapper
{
public:
    paam_client_wrapper(int callback_priority_, int chain_priority, rclcpp::Publisher<paam_server_interfaces::msg::GPURequest>::SharedPtr request_publisher, rclcpp::Publisher<paam_server_interfaces::msg::GPURegister>::SharedPtr reg_publisher)
    ...
    void paam_tpu_wrapper(bool sleep)
    {
        #ifdef DEBUG_TIME
        timeval t1, t2;
        #endif
    ...
    void paam_gemm_wrapper(bool sleep)
    {
        #ifdef DEBUG_TIME
        timeval t1, t2;
        #endif
    ...
    void register_subscriber(rclcpp::Subscription<paam_server_interfaces::msg::GPURegister>::SharedPtr register_sub)
    {
    ...
    paam_client_wrapper &operator=(const paam_client_wrapper &other)
    {
        if (this != &other)
        {
            pid = other.pid;
    ...
    paam_client_wrapper(const paam_client_wrapper &other)
    {
        pid = other.pid;
        tpu_shm = other.tpu_shm;
        gemm_shm = other.gemm_shm;
    ...
    rclcpp::Subscription<paam_server_interfaces::msg::GPURegister>::SharedPtr register_sub_ = nullptr;
...
private:
    ...
    void populateLoanedGEMMMessage(rclcpp::LoanedMessage<paam_server_interfaces::msg::GPURequest> &loanedMsg)
    {
...
#endif // REFERENCE_SYSTEM__paam_WRAPPERS_HPP_